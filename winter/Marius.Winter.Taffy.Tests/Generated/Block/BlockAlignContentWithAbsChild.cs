...
public class BlockAlignContentWithAbsChild
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node1 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(10f), LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(5f), LengthPercentageAuto.AUTO),
        });
