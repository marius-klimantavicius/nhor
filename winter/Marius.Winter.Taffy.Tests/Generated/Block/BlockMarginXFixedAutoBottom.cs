...
public class BlockMarginXFixedAutoBottom
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            SizeValue = new Size<Dimension>(Dimension.FromLength(20f), Dimension.FromLength(10f)),
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.ZERO, LengthPercentageAuto.ZERO, LengthPercentageAuto.ZERO, LengthPercentageAuto.AUTO),
        });
