...
public class BlockAbsoluteAspectRatioAspectRatioOverridesHeightOfFullInset
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            AspectRatioValue = 3f,
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Percent(0.05f), LengthPercentageAuto.Percent(0.05f), LengthPercentageAuto.Percent(0.05f), LengthPercentageAuto.Percent(0.05f)),
        });
        ...
        Assert.Equal(360f, layout_node0.Size.Width);
