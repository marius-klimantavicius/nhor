...
public class BlockMarginYFirstChildCollapseBlockedByPaddingTop
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            Display = Display.Block,
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.ZERO, LengthPercentageAuto.ZERO, LengthPercentageAuto.Length(10f), LengthPercentageAuto.ZERO),
            PaddingValue = new Rect<LengthPercentage>(LengthPercentage.ZERO, LengthPercentage.ZERO, LengthPercentage.Length(1f), LengthPercentage.ZERO),
        }, new NodeId[] { node00 });
        ...
        Assert.Equal(31f, layout_node.Size.Height);
        Assert.Equal(0f, layout_node.Location.X);
        Assert.Equal(0f, layout_node.Location.Y);
        var layout_node0 = taffy.GetLayout(node0);
        Assert.Equal(50f, layout_node0.Size.Width);
        Assert.Equal(21f, layout_node0.Size.Height);
        ...
        Assert.Equal(11f, layout_node00.Location.Y);
