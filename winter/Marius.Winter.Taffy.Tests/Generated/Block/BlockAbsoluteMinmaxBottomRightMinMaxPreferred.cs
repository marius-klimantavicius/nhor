...
public class BlockAbsoluteMinmaxBottomRightMinMaxPreferred
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(10f), LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(10f)),
        });
