...
public class BlockAbsoluteLayoutWithinBorder
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node1 = taffy.NewLeaf(new Style
        {
            ...
            PositionValue = Position.Absolute,
            SizeValue = new Size<Dimension>(Dimension.FromLength(50f), Dimension.FromLength(50f)),
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(0f), LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(0f)),
        });
