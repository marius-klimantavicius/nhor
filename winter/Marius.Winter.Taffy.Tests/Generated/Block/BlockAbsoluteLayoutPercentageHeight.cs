...
public class BlockAbsoluteLayoutPercentageHeight
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(10f), Dimension.FromPercent(0.5f)),
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(10f), LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(10f), LengthPercentageAuto.AUTO),
        });
