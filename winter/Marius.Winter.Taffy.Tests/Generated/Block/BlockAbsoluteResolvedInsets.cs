...
public class BlockAbsoluteResolvedInsets
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style(), new NodeId[] { node0, node1, node2 });
        ...
        Assert.Equal(35f, layout_node00.Location.X);
        Assert.Equal(35f, layout_node00.Location.Y);
        ...
        Assert.Equal(35f, layout_node10.Location.X);
        Assert.Equal(35f, layout_node10.Location.Y);
        ...
        Assert.Equal(200f, layout_node2.Size.Width);
        Assert.Equal(200f, layout_node2.Size.Height);
        Assert.Equal(400f, layout_node2.Location.X);
        ...
        Assert.Equal(35f, layout_node20.Location.X);
        Assert.Equal(35f, layout_node20.Location.Y);
        var layout_node21 = taffy.GetLayout(node21);
        Assert.Equal(0f, layout_node21.Size.Width);
        Assert.Equal(0f, layout_node21.Size.Height);
        Assert.Equal(35f, layout_node21.Location.X);
        Assert.Equal(45f, layout_node21.Location.Y);
    }
    ...
    public void ContentBox()
    {
        ...
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(810f, layout_node.Size.Width);
        ...
        Assert.Equal(20f, layout_node15.Location.Y);
        var layout_node2 = taffy.GetLayout(node2);
        Assert.Equal(270f, layout_node2.Size.Width);
        Assert.Equal(270f, layout_node2.Size.Height);
        Assert.Equal(540f, layout_node2.Location.X);
        Assert.Equal(0f, layout_node2.Location.Y);
        var layout_node20 = taffy.GetLayout(node20);
        Assert.Equal(50f, layout_node20.Size.Width);
        Assert.Equal(10f, layout_node20.Size.Height);
