...
public class BlockAbsoluteMarginAutoTopWithInset
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(20f), LengthPercentageAuto.Length(10f)),
        });
        ...
        Assert.Equal(140f, layout_node0.Location.Y);
    }
