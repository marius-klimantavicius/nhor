...
public class BlockMarginYCollapseThroughPositiveAndNegative
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            Display = Display.Block,
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.ZERO, LengthPercentageAuto.ZERO, LengthPercentageAuto.Length(5f), LengthPercentageAuto.Length(-4f)),
        });
        ...
        Assert.Equal(17f, layout_node.Size.Height);
        ...
        Assert.Equal(7f, layout_node2.Location.Y);
    }
