...
public class BlockMarginYCollapseThroughBlockedByPaddingBottom
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node1 = taffy.NewLeaf(new Style
        {
            ...
            PaddingValue = new Rect<LengthPercentage>(LengthPercentage.ZERO, LengthPercentage.ZERO, LengthPercentage.ZERO, LengthPercentage.Length(1f)),
        });
        ...
        Assert.Equal(41f, layout_node.Size.Height);
        ...
        Assert.Equal(1f, layout_node1.Size.Height);
        ...
        Assert.Equal(31f, layout_node2.Location.Y);
    }
