...
public class BlockAbsoluteChildWithMaxHeight
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node00 = taffy.NewLeaf(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(100f), Dimension.FromLength(150f)),
        });
        ...
        Assert.Equal(150f, layout_node00.Size.Height);
