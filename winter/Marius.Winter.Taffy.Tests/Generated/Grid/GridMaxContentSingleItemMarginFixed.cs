...
public class GridMaxContentSingleItemMarginFixed
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.MaxContentComponent(), GridTemplateComponent.FromLength(40f)),
        ...
        Assert.Equal(110f, layout_node2.Location.X);
        ...
        Assert.Equal(70f, layout_node4.Size.Width);
        ...
        Assert.Equal(110f, layout_node5.Location.X);
        ...
        Assert.Equal(70f, layout_node7.Size.Width);
        ...
        Assert.Equal(110f, layout_node8.Location.X);
