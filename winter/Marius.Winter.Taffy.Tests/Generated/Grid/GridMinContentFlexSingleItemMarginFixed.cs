...
public class GridMinContentFlexSingleItemMarginFixed
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node1 = taffy.NewLeaf(new Style
        {
            ...
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(20f), LengthPercentageAuto.Length(10f), LengthPercentageAuto.Length(5f), LengthPercentageAuto.Length(15f)),
        });
        ...
        Assert.Equal(60f, layout_node4.Location.X);
        ...
        Assert.Equal(80f, layout_node7.Location.X);
