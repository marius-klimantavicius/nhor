...
public class GridAutoSingleItemFixedWidth
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.AutoComponent(), GridTemplateComponent.AutoComponent()),
        ...
        Assert.Equal(170f, layout_node2.Location.X);
        ...
        Assert.Equal(130f, layout_node4.Size.Width);
        ...
        Assert.Equal(30f, layout_node5.Size.Width);
        Assert.Equal(40f, layout_node5.Size.Height);
        Assert.Equal(170f, layout_node5.Location.X);
        ...
        Assert.Equal(130f, layout_node7.Size.Width);
        ...
        Assert.Equal(30f, layout_node8.Size.Width);
        Assert.Equal(40f, layout_node8.Size.Height);
        Assert.Equal(170f, layout_node8.Location.X);
