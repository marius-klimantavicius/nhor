...
public class GridMaxWidthSmallerThanMinContent
{
    [Fact]
    public void BorderBox()
    {
        var taffy = NewTestTree();
        var node00 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HHHH\u200bHHHH", WritingMode.Horizontal));
        var node01 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HHHH\u200bHHHH", WritingMode.Horizontal));
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            MaxSizeValue = new Size<Dimension>(Dimension.FromLength(60f), Dimension.Auto()),
