...
public class GridAbsoluteWithPadding
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(180f, layout_node0.Location.X);
        Assert.Equal(0f, layout_node0.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(0f, layout_node1.Size.Width);
        Assert.Equal(0f, layout_node1.Size.Height);
        Assert.Equal(10f, layout_node1.Location.X);
        Assert.Equal(150f, layout_node1.Location.Y);
