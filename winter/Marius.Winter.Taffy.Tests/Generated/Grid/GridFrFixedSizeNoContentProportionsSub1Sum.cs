...
public class GridFrFixedSizeNoContentProportionsSub1Sum
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromFr(0.3f), GridTemplateComponent.FromFr(0.2f)),
