...
public class GridSpan6AllNonFlexIndefiniteHidden
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(19f, layout_node1.Size.Width);
        ...
        Assert.Equal(99f, layout_node2.Size.Width);
        Assert.Equal(40f, layout_node2.Size.Height);
        Assert.Equal(19f, layout_node2.Location.X);
        ...
        Assert.Equal(118f, layout_node3.Location.X);
        ...
        Assert.Equal(118f, layout_node4.Location.X);
