...
public class GridMaxContentMaximumSingleItem
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.FromSingle(new MinMax<MinTrackSizingFunction, MaxTrackSizingFunction>(MinTrackSizingFunction.Length(0f), MaxTrackSizingFunction.MAX_CONTENT)), GridTemplateComponent.FromLength(40f)),
