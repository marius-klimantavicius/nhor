...
public class GridAvailableSpaceSmallerThanMaxContent
{
    [Fact]
    public void BorderBox()
    {
        ...
        taffy.ComputeLayoutWithMeasure(node, new Size<AvailableSpace>(AvailableSpace.Definite(80f), AvailableSpace.MaxContent), MeasureFunction);
