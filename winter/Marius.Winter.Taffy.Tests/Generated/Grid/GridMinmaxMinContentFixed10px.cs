...
public class GridMinmaxMinContentFixed10px
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromSingle(new MinMax<MinTrackSizingFunction, MaxTrackSizingFunction>(MinTrackSizingFunction.MIN_CONTENT, MaxTrackSizingFunction.Length(10f)))),
        }, new NodeId[] { node0 });
