...
public class GridMarginsFixedCenter
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            JustifySelfValue = AlignItems.Center,
            SizeValue = new Size<Dimension>(Dimension.FromLength(20f), Dimension.FromLength(20f)),
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(8f), LengthPercentageAuto.Length(4f), LengthPercentageAuto.Length(2f), LengthPercentageAuto.Length(6f)),
        });
