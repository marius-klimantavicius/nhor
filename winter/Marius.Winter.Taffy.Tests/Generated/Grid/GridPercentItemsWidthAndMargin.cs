...
public class GridPercentItemsWidthAndMargin
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(6f, layout_node0.Size.Height);
    ...
    public void ContentBox()
    {
        ...
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(206f, layout_node.Size.Width);
        Assert.Equal(32f, layout_node.Size.Height);
        Assert.Equal(0f, layout_node.Location.X);
        Assert.Equal(0f, layout_node.Location.Y);
        var layout_node0 = taffy.GetLayout(node0);
        Assert.Equal(96f, layout_node0.Size.Width);
        Assert.Equal(6f, layout_node0.Size.Height);
        Assert.Equal(13f, layout_node0.Location.X);
        Assert.Equal(13f, layout_node0.Location.Y);
    }
