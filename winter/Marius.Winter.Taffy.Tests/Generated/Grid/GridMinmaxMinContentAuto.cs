...
public class GridMinmaxMinContentAuto
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromSingle(new MinMax<MinTrackSizingFunction, MaxTrackSizingFunction>(MinTrackSizingFunction.MIN_CONTENT, MaxTrackSizingFunction.AUTO))),
        }, new NodeId[] { node0 });
