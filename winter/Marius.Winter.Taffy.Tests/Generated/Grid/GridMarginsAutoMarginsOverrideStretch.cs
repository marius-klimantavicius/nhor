...
public class GridMarginsAutoMarginsOverrideStretch
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node6 = taffy.NewLeafWithContext(new Style
        {
            AlignSelfValue = AlignItems.Stretch,
            JustifySelfValue = AlignItems.Stretch,
        ...
        Assert.Equal(105f, layout_node6.Location.Y);
