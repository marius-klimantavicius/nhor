...
public class GridRepeatInteger
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateRows = ImmutableList.Create(GridTemplateComponent.FromRepeat(new GridTemplateRepetition(RepetitionCount.Count((ushort)3), ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(40f))))),
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromRepeat(new GridTemplateRepetition(RepetitionCount.Count((ushort)3), ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(40f))))),
