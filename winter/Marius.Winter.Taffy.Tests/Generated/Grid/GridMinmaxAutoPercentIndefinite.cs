...
public class GridMinmaxAutoPercentIndefinite
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromSingle(new MinMax<MinTrackSizingFunction, MaxTrackSizingFunction>(MinTrackSizingFunction.AUTO, MaxTrackSizingFunction.Percent(0.2f)))),
        }, new NodeId[] { node0 });
        ...
        Assert.Equal(8f, layout_node0.Size.Width);
