...
public class GridFrSpan2ProportionSub1Sum
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromFr(0.2f), GridTemplateComponent.FromFr(0.3f)),
        ...
        Assert.Equal(24f, layout_node2.Location.X);
