...
public class GridMaxWidthGreaterThanMaxContent
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            MaxSizeValue = new Size<Dimension>(Dimension.FromLength(400f), Dimension.Auto()),
        ...
        Assert.Equal(80f, layout_node01.Location.X);
