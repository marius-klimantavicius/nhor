...
public class GridOutOfOrderItems
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node2 = taffy.NewLeaf(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(35f), Dimension.FromLength(35f)),
        });
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridAutoFlowValue = GridAutoFlow.RowDense,
        ...
        Assert.Equal(35f, layout_node2.Size.Width);
        Assert.Equal(35f, layout_node2.Size.Height);
        Assert.Equal(0f, layout_node2.Location.X);
        Assert.Equal(80f, layout_node2.Location.Y);
        ...
        Assert.Equal(10f, layout_node7.Size.Width);
        Assert.Equal(10f, layout_node7.Size.Height);
