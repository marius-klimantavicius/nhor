...
public class GridOverflowInlineAxisVisible
{
    [Fact]
    public void BorderBox()
    {
        var taffy = NewTestTree();
        var node0 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HHHHHHHHHH", WritingMode.Horizontal));
    ...
    public void ContentBox()
    {
        ...
        }, TestNodeContext.AhemText("HHHHHHHHHH", WritingMode.Horizontal));
        var node = taffy.NewWithChildren(new Style
        {
            Display = Display.Grid,
            BoxSizingValue = BoxSizing.ContentBox,
