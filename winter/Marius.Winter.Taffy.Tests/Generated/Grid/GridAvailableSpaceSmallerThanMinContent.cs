...
public class GridAvailableSpaceSmallerThanMinContent
{
    [Fact]
    public void BorderBox()
    {
        var taffy = NewTestTree();
        var node0 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HHHH\u200bHHHH", WritingMode.Horizontal));
        var node1 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HHHH\u200bHHHH", WritingMode.Horizontal));
        ...
        taffy.ComputeLayoutWithMeasure(node, new Size<AvailableSpace>(AvailableSpace.Definite(60f), AvailableSpace.MaxContent), MeasureFunction);
