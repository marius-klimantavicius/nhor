...
public class GridAbsoluteContainerBottomLeftMargin
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(0f), LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(0f)),
        });
        ...
        Assert.Equal(147f, layout_node0.Location.Y);
