...
public class GridAbsoluteContainerNegativePositionMargin
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(-15f), LengthPercentageAuto.Length(-5f), LengthPercentageAuto.AUTO),
        });
        var node1 = taffy.NewLeaf(new Style
        {
            PositionValue = Position.Absolute,
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(4f), LengthPercentageAuto.Length(2f), LengthPercentageAuto.Length(1f), LengthPercentageAuto.Length(3f)),
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(-35f), LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(-25f)),
        });
        ...
        Assert.Equal(193f, layout_node0.Location.X);
        Assert.Equal(-4f, layout_node0.Location.Y);
        ...
        Assert.Equal(182f, layout_node1.Location.Y);
        ...
        Assert.Equal(120f, layout_node4.Location.X);
        Assert.Equal(10f, layout_node4.Location.Y);
