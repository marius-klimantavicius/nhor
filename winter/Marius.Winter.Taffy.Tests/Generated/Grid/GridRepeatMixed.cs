...
public class GridRepeatMixed
{
    ...
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateRows = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.FromRepeat(new GridTemplateRepetition(RepetitionCount.Count((ushort)1), ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(40f)))), GridTemplateComponent.FromRepeat(new GridTemplateRepetition(RepetitionCount.AutoFill, ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(40f))))),
