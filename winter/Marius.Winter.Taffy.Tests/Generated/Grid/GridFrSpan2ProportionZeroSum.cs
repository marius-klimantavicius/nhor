...
public class GridFrSpan2ProportionZeroSum
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromFr(0f), GridTemplateComponent.FromFr(0f)),
        ...
        Assert.Equal(30f, layout_node2.Location.X);
