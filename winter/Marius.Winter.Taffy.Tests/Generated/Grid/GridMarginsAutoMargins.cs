...
public class GridMarginsAutoMargins
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node2 = taffy.NewLeaf(new Style
        {
            ...
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(0f), LengthPercentageAuto.Length(0f)),
        });
        ...
        var node4 = taffy.NewLeaf(new Style
        {
            ...
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(0f), LengthPercentageAuto.Length(0f), LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO),
        });
        ...
        Assert.Equal(130f, layout_node2.Location.X);
        ...
        Assert.Equal(60f, layout_node4.Location.Y);
        ...
        Assert.Equal(100f, layout_node6.Location.Y);
