...
public class GridAutoColumns
{
    ...
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridAutoColumns = ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(10f), TrackSizingFunctionExtensions.FromLength(20f), TrackSizingFunctionExtensions.FromLength(30f)),
            GridAutoFlowValue = GridAutoFlow.Column,
        }, new NodeId[] { node0, node1, node2, node3, node4, node5, node6, node7 });
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(190f, layout_node.Size.Width);
        ...
        Assert.Equal(70f, layout_node2.Location.X);
        ...
        Assert.Equal(100f, layout_node5.Size.Height);
        Assert.Equal(130f, layout_node5.Location.X);
        Assert.Equal(0f, layout_node5.Location.Y);
        var layout_node6 = taffy.GetLayout(node6);
        Assert.Equal(20f, layout_node6.Size.Width);
        Assert.Equal(100f, layout_node6.Size.Height);
        Assert.Equal(140f, layout_node6.Location.X);
        Assert.Equal(0f, layout_node6.Location.Y);
        var layout_node7 = taffy.GetLayout(node7);
        Assert.Equal(30f, layout_node7.Size.Width);
        Assert.Equal(100f, layout_node7.Size.Height);
        Assert.Equal(160f, layout_node7.Location.X);
        Assert.Equal(0f, layout_node7.Location.Y);
    }
