...
public class GridSpan8AllTrackTypesIndefinite
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            GridColumn = new Line<GridPlacement>(GridPlacement.FromLine((short)1), GridPlacement.FromSpanCount((ushort)8)),
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.MinContentComponent(), GridTemplateComponent.MaxContentComponent(), GridTemplateComponent.FitContentComponent(LengthPercentage.Length(20f)), GridTemplateComponent.AutoComponent(), GridTemplateComponent.FromLength(10f), GridTemplateComponent.FromPercent(0.2f), GridTemplateComponent.FromFr(1f), GridTemplateComponent.FromFr(2f)),
