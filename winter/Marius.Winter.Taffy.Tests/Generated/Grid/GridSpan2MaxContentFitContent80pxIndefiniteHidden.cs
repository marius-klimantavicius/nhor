...
public class GridSpan2MaxContentFitContent80pxIndefiniteHidden
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.MaxContentComponent(), GridTemplateComponent.FitContentComponent(LengthPercentage.Length(80f))),
