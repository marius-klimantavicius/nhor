...
public class GridAbsoluteWithPaddingAndMargin
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(0f), LengthPercentageAuto.Length(0f), LengthPercentageAuto.AUTO),
        });
        var node1 = taffy.NewLeaf(new Style
        {
            PositionValue = Position.Absolute,
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(4f), LengthPercentageAuto.Length(2f), LengthPercentageAuto.Length(1f), LengthPercentageAuto.Length(3f)),
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(10f), LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO, LengthPercentageAuto.Length(10f)),
        });
        ...
        Assert.Equal(178f, layout_node0.Location.X);
        ...
        Assert.Equal(14f, layout_node1.Location.X);
        Assert.Equal(147f, layout_node1.Location.Y);
