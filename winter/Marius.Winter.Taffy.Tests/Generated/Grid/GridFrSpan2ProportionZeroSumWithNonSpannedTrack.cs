...
public class GridFrSpan2ProportionZeroSumWithNonSpannedTrack
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromFr(0f), GridTemplateComponent.FromFr(0f), GridTemplateComponent.FromFr(0f)),
