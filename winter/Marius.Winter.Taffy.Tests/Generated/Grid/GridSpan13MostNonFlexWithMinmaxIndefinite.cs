...
public class GridSpan13MostNonFlexWithMinmaxIndefinite
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(11f, layout_node1.Size.Width);
        ...
        Assert.Equal(124f, layout_node5.Location.X);
        Assert.Equal(40f, layout_node5.Location.Y);
        var layout_node6 = taffy.GetLayout(node6);
        Assert.Equal(65f, layout_node6.Size.Width);
        Assert.Equal(40f, layout_node6.Size.Height);
        Assert.Equal(134f, layout_node6.Location.X);
        ...
        Assert.Equal(199f, layout_node7.Location.X);
        ...
        Assert.Equal(201f, layout_node8.Location.X);
        ...
        Assert.Equal(205f, layout_node9.Location.X);
