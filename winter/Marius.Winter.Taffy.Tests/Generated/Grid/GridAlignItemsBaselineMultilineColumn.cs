...
public class GridAlignItemsBaselineMultilineColumn
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            Display = Display.Grid,
            SizeValue = new Size<Dimension>(Dimension.FromLength(40f), Dimension.FromLength(70f)),
        }, new NodeId[] { node20 });
        ...
        Assert.Equal(70f, layout_node2.Size.Height);
