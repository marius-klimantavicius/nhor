...
public class GridAbsoluteContainerLeftRightMargin
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(5f), LengthPercentageAuto.Length(2f), LengthPercentageAuto.AUTO, LengthPercentageAuto.AUTO),
        });
        ...
        Assert.Equal(167f, layout_node0.Size.Width);
        Assert.Equal(0f, layout_node0.Size.Height);
        Assert.Equal(9f, layout_node0.Location.X);
        ...
        Assert.Equal(120f, layout_node3.Location.X);
        ...
        Assert.Equal(120f, layout_node6.Location.X);
