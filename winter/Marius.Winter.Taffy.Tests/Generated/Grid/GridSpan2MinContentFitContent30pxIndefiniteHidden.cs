...
public class GridSpan2MinContentFitContent30pxIndefiniteHidden
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.MinContentComponent(), GridTemplateComponent.FitContentComponent(LengthPercentage.Length(30f))),
        ...
        Assert.Equal(70f, layout_node2.Size.Width);
        Assert.Equal(40f, layout_node2.Size.Height);
        Assert.Equal(0f, layout_node2.Location.X);
        Assert.Equal(0f, layout_node2.Location.Y);
        Assert.Equal(0f, layout_node2.ScrollWidth());
        Assert.Equal(0f, layout_node2.ScrollHeight());
    }
