...
public class GridBasicWithOverflow
{
    [Fact]
    public void BorderBox()
    {
        ...
        }, new NodeId[] { node0, node1, node2, node3, node4, node5, node6, node7, node8, node9 });
        ...
        Assert.Equal(0f, layout_node9.Size.Height);
        Assert.Equal(0f, layout_node9.Location.X);
        Assert.Equal(120f, layout_node9.Location.Y);
    }
