...
public class GridAbsoluteRowEnd
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            GridRow = new Line<GridPlacement>(GridPlacement.Auto, GridPlacement.FromLine((short)1)),
        ...
        Assert.Equal(7f, layout_node0.Size.Height);
