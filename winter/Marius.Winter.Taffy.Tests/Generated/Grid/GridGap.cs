...
public class GridGap
{
    ...
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GapValue = new Size<LengthPercentage>(LengthPercentage.Length(40f), LengthPercentage.Length(40f)),
        ...
        Assert.Equal(160f, layout_node2.Location.X);
        ...
        Assert.Equal(160f, layout_node5.Location.X);
        ...
        Assert.Equal(160f, layout_node6.Location.Y);
        ...
        Assert.Equal(160f, layout_node8.Location.X);
