...
public class GridAutoRows
{
    ...
    public void BorderBox()
    {
        ...
        {
            GridRow = new Line<GridPlacement>(GridPlacement.FromLine((short)-4), GridPlacement.Auto),
        });
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridAutoRows = ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(10f), TrackSizingFunctionExtensions.FromLength(20f), TrackSizingFunctionExtensions.FromLength(30f)),
        }, new NodeId[] { node0, node1, node2, node3, node4, node5, node6, node7 });
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(100f, layout_node.Size.Width);
        Assert.Equal(180f, layout_node.Size.Height);
        ...
        Assert.Equal(160f, layout_node7.Location.Y);
    }
