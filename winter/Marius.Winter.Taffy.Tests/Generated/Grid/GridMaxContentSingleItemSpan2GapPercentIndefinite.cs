...
public class GridMaxContentSingleItemSpan2GapPercentIndefinite
{
    [Fact]
    public void BorderBox()
    {
        ...
        }, TestNodeContext.AhemText("HH\u200bHH\u200bHH", WritingMode.Horizontal));
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GapValue = new Size<LengthPercentage>(LengthPercentage.Percent(0.2f), LengthPercentage.ZERO),
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.MaxContentComponent(), GridTemplateComponent.MaxContentComponent()),
        ...
        Assert.Equal(60f, layout_node3.Location.X);
        ...
        Assert.Equal(100f, layout_node4.Location.X);
        ...
        Assert.Equal(60f, layout_node6.Location.X);
