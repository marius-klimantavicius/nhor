...
public class GridMinContentFlexSingleItemMarginPercent
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            MinSizeValue = new Size<Dimension>(Dimension.FromLength(10f), Dimension.Auto()),
        ...
        {
            GridColumn = new Line<GridPlacement>(GridPlacement.FromSpanCount((ushort)2), GridPlacement.Auto),
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Percent(0.2f), LengthPercentageAuto.Percent(0.1f), LengthPercentageAuto.Percent(0.05f), LengthPercentageAuto.Percent(0.15f)),
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.MinContentComponent(), GridTemplateComponent.FromFr(1f)),
        ...
        Assert.Equal(38f, layout_node1.Size.Height);
        Assert.Equal(42f, layout_node1.Location.X);
        ...
        Assert.Equal(28f, layout_node4.Size.Width);
        Assert.Equal(32f, layout_node4.Size.Height);
        Assert.Equal(48f, layout_node4.Location.X);
        Assert.Equal(42f, layout_node4.Location.Y);
        ...
        Assert.Equal(10f, layout_node6.Size.Width);
        Assert.Equal(40f, layout_node6.Size.Height);
        Assert.Equal(40f, layout_node6.Location.X);
        Assert.Equal(80f, layout_node6.Location.Y);
        var layout_node7 = taffy.GetLayout(node7);
        Assert.Equal(30f, layout_node7.Size.Width);
        Assert.Equal(40f, layout_node7.Size.Height);
        Assert.Equal(50f, layout_node7.Location.X);
