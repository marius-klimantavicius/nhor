...
public class GridMinmaxMaxContent1fr
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromSingle(new MinMax<MinTrackSizingFunction, MaxTrackSizingFunction>(MinTrackSizingFunction.MAX_CONTENT, MaxTrackSizingFunction.Fr(1f)))),
        }, new NodeId[] { node0 });
