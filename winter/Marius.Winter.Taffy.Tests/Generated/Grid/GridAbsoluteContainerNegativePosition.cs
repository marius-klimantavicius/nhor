...
public class GridAbsoluteContainerNegativePosition
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(195f, layout_node0.Location.X);
        ...
        Assert.Equal(-35f, layout_node1.Location.X);
        Assert.Equal(185f, layout_node1.Location.Y);
