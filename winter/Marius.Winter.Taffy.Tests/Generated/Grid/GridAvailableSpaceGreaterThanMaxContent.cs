...
public class GridAvailableSpaceGreaterThanMaxContent
{
    [Fact]
    public void BorderBox()
    {
        var taffy = NewTestTree();
        var node0 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HH\u200bHH\u200bHH\u200bHH", WritingMode.Horizontal));
        var node1 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("HH\u200bHH\u200bHH\u200bHH", WritingMode.Horizontal));
        ...
        taffy.ComputeLayoutWithMeasure(node, new Size<AvailableSpace>(AvailableSpace.Definite(400f), AvailableSpace.MaxContent), MeasureFunction);
