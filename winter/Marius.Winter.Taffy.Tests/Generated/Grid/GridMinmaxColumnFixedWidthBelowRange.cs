...
public class GridMinmaxColumnFixedWidthBelowRange
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(90f), Dimension.Auto()),
        }, new NodeId[] { node0, node1, node2, node3, node4, node5, node6, node7, node8 });
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(90f, layout_node.Size.Width);
