...
public class GridSpan2MinContentAutoIndefiniteHidden
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.MinContentComponent(), GridTemplateComponent.AutoComponent()),
