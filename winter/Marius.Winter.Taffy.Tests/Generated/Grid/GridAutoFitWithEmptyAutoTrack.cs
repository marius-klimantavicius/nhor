...
public class GridAutoFitWithEmptyAutoTrack
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromRepeat(new GridTemplateRepetition(RepetitionCount.AutoFit, ImmutableList.Create(TrackSizingFunctionExtensions.FromLength(40f))))),
