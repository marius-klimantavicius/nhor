...
public class GridAlignContentCenterNegativeSpaceGap
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(40f, layout_node02.Size.Height);
        ...
        Assert.Equal(40f, layout_node03.Size.Height);
        Assert.Equal(20f, layout_node03.Location.X);
        Assert.Equal(40f, layout_node03.Location.Y);
        var layout_node04 = taffy.GetLayout(node04);
        Assert.Equal(20f, layout_node04.Size.Width);
        Assert.Equal(40f, layout_node04.Size.Height);
        Assert.Equal(50f, layout_node04.Location.X);
        Assert.Equal(40f, layout_node04.Location.Y);
        var layout_node05 = taffy.GetLayout(node05);
        Assert.Equal(20f, layout_node05.Size.Width);
        Assert.Equal(40f, layout_node05.Size.Height);
        Assert.Equal(80f, layout_node05.Location.X);
        Assert.Equal(40f, layout_node05.Location.Y);
        var layout_node06 = taffy.GetLayout(node06);
        Assert.Equal(20f, layout_node06.Size.Width);
        Assert.Equal(40f, layout_node06.Size.Height);
        Assert.Equal(20f, layout_node06.Location.X);
        Assert.Equal(90f, layout_node06.Location.Y);
        var layout_node07 = taffy.GetLayout(node07);
        Assert.Equal(20f, layout_node07.Size.Width);
        Assert.Equal(40f, layout_node07.Size.Height);
        Assert.Equal(50f, layout_node07.Location.X);
        Assert.Equal(90f, layout_node07.Location.Y);
        var layout_node08 = taffy.GetLayout(node08);
        Assert.Equal(20f, layout_node08.Size.Width);
        Assert.Equal(40f, layout_node08.Size.Height);
        Assert.Equal(80f, layout_node08.Location.X);
        Assert.Equal(90f, layout_node08.Location.Y);
    }
