...
public class GridFrFixedSizeSingleItem
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateRows = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.FromFr(1f), GridTemplateComponent.FromFr(1f)),
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FromLength(40f), GridTemplateComponent.FromFr(1f), GridTemplateComponent.FromFr(1f)),
        ...
        Assert.Equal(80f, layout_node5.Size.Height);
        Assert.Equal(140f, layout_node5.Location.X);
        Assert.Equal(40f, layout_node5.Location.Y);
        var layout_node6 = taffy.GetLayout(node6);
        Assert.Equal(40f, layout_node6.Size.Width);
        Assert.Equal(80f, layout_node6.Size.Height);
        Assert.Equal(0f, layout_node6.Location.X);
        Assert.Equal(120f, layout_node6.Location.Y);
        var layout_node7 = taffy.GetLayout(node7);
        Assert.Equal(100f, layout_node7.Size.Width);
        Assert.Equal(80f, layout_node7.Size.Height);
        Assert.Equal(40f, layout_node7.Location.X);
        Assert.Equal(120f, layout_node7.Location.Y);
        var layout_node8 = taffy.GetLayout(node8);
        Assert.Equal(60f, layout_node8.Size.Width);
        Assert.Equal(80f, layout_node8.Size.Height);
        Assert.Equal(140f, layout_node8.Location.X);
        Assert.Equal(120f, layout_node8.Location.Y);
    }
