...
public class GridFitContentPointsMinContent
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FitContentComponent(LengthPercentage.Length(30f))),
        }, new NodeId[] { node0 });
