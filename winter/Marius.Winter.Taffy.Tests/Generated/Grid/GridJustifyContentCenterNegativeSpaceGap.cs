...
public class GridJustifyContentCenterNegativeSpaceGap
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(90f, layout_node02.Location.X);
        ...
        Assert.Equal(-10f, layout_node03.Location.X);
        ...
        Assert.Equal(40f, layout_node04.Location.X);
        ...
        Assert.Equal(90f, layout_node05.Location.X);
        ...
        Assert.Equal(-10f, layout_node06.Location.X);
        ...
        Assert.Equal(40f, layout_node07.Location.X);
        ...
        Assert.Equal(90f, layout_node08.Location.X);
