...
public class GridPercentTracksIndefiniteWithContentUnderflow
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(10f, layout_node4.Size.Width);
        ...
        Assert.Equal(10f, layout_node5.Location.X);
        Assert.Equal(30f, layout_node5.Location.Y);
        var layout_node6 = taffy.GetLayout(node6);
        Assert.Equal(30f, layout_node6.Size.Width);
        Assert.Equal(60f, layout_node6.Size.Height);
        Assert.Equal(30f, layout_node6.Location.X);
        Assert.Equal(30f, layout_node6.Location.Y);
    }
