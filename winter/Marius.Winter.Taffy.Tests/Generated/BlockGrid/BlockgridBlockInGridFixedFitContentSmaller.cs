...
public class BlockgridBlockInGridFixedFitContentSmaller
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            GridTemplateColumns = ImmutableList.Create(GridTemplateComponent.FitContentComponent(LengthPercentage.Length(10f))),
