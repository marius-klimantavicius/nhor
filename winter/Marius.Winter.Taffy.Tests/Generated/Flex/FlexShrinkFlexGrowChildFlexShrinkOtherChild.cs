...
public class FlexShrinkFlexGrowChildFlexShrinkOtherChild
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            FlexGrowValue = 0f,
            FlexShrinkValue = 1f,
            SizeValue = new Size<Dimension>(Dimension.FromLength(500f), Dimension.FromLength(100f)),
        });
        ...
        Assert.Equal(250f, layout_node0.Size.Width);
        Assert.Equal(100f, layout_node0.Size.Height);
        Assert.Equal(0f, layout_node0.Location.X);
        Assert.Equal(0f, layout_node0.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(250f, layout_node1.Size.Width);
        Assert.Equal(100f, layout_node1.Size.Height);
        Assert.Equal(250f, layout_node1.Location.X);
