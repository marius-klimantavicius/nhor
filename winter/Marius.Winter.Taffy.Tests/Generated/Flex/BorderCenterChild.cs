...
public class BorderCenterChild
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            BorderValue = new Rect<LengthPercentage>(LengthPercentage.ZERO, LengthPercentage.ZERO, LengthPercentage.Length(10f), LengthPercentage.Length(20f)),
        }, new NodeId[] { node0 });
        ...
        Assert.Equal(45f, layout_node0.Location.X);
