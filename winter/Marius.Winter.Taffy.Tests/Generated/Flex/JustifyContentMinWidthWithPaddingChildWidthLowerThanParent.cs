...
public class JustifyContentMinWidthWithPaddingChildWidthLowerThanParent
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node000 = taffy.NewLeaf(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(199f), Dimension.FromLength(100f)),
        });
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            AlignContentValue = AlignContent.Stretch,
            SizeValue = new Size<Dimension>(Dimension.FromLength(1080f), Dimension.FromLength(1584f)),
        }, new NodeId[] { node0 });
        ...
        Assert.Equal(400f, layout_node00.Size.Width);
        ...
        Assert.Equal(199f, layout_node000.Size.Width);
        Assert.Equal(100f, layout_node000.Size.Height);
        Assert.Equal(101f, layout_node000.Location.X);
    ...
    public void ContentBox()
    {
        ...
        Assert.Equal(199f, layout_node000.Size.Width);
        Assert.Equal(100f, layout_node000.Size.Height);
        Assert.Equal(201f, layout_node000.Location.X);
        Assert.Equal(0f, layout_node000.Location.Y);
    }
}
