...
public class WrappedColumnMaxHeightFlex
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(300f, layout_node0.Location.X);
        Assert.Equal(0f, layout_node0.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(200f, layout_node1.Size.Width);
        Assert.Equal(180f, layout_node1.Size.Height);
        ...
        Assert.Equal(300f, layout_node2.Location.X);
        Assert.Equal(400f, layout_node2.Location.Y);
    }
