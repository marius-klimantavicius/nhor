...
public class PercentageFlexBasis
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            FlexGrowValue = 1f,
            FlexBasisValue = Dimension.FromPercent(0.25f),
        });
        ...
        Assert.Equal(125f, layout_node0.Size.Width);
        Assert.Equal(200f, layout_node0.Size.Height);
        Assert.Equal(0f, layout_node0.Location.X);
        Assert.Equal(0f, layout_node0.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(75f, layout_node1.Size.Width);
        Assert.Equal(200f, layout_node1.Size.Height);
        Assert.Equal(125f, layout_node1.Location.X);
