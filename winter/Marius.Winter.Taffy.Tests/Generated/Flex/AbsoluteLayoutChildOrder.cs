...
public class AbsoluteLayoutChildOrder
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(55f, layout_node0.Size.Width);
        ...
        Assert.Equal(25f, layout_node1.Location.X);
        Assert.Equal(30f, layout_node1.Location.Y);
        var layout_node2 = taffy.GetLayout(node2);
        Assert.Equal(55f, layout_node2.Size.Width);
        Assert.Equal(40f, layout_node2.Size.Height);
        Assert.Equal(55f, layout_node2.Location.X);
