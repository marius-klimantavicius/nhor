...
public class PercentWithinFlexGrow
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            SizeValue = new Size<Dimension>(Dimension.FromLength(350f), Dimension.FromLength(100f)),
        }, new NodeId[] { node0, node1, node2 });
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(350f, layout_node.Size.Width);
        ...
        Assert.Equal(150f, layout_node1.Size.Width);
        ...
        Assert.Equal(150f, layout_node10.Size.Width);
        ...
        Assert.Equal(250f, layout_node2.Location.X);
