...
public class MultilineMinMax12
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            PaddingValue = new Rect<LengthPercentage>(LengthPercentage.Length(10f), LengthPercentage.ZERO, LengthPercentage.ZERO, LengthPercentage.ZERO),
        });
