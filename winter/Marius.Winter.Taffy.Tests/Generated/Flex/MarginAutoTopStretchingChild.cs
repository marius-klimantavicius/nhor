...
public class MarginAutoTopStretchingChild
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(200f, layout_node0.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(50f, layout_node1.Size.Width);
        Assert.Equal(50f, layout_node1.Size.Height);
        Assert.Equal(150f, layout_node1.Location.X);
        Assert.Equal(75f, layout_node1.Location.Y);
    }
