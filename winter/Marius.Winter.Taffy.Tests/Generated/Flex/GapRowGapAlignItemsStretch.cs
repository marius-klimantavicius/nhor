...
public class GapRowGapAlignItemsStretch
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(90f, layout_node1.Size.Height);
        ...
        Assert.Equal(90f, layout_node2.Size.Height);
