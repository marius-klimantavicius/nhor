...
public class MinMaxPercentDifferentWidthHeight
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            MinSizeValue = new Size<Dimension>(Dimension.FromPercent(0.1f), Dimension.FromPercent(0.1f)),
            MaxSizeValue = new Size<Dimension>(Dimension.FromPercent(0.1f), Dimension.FromPercent(0.1f)),
