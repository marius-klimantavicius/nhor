...
public class AlignItemsCenterWithMinHeightWithPaddingBorder
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            BorderValue = new Rect<LengthPercentage>(LengthPercentage.Length(7f), LengthPercentage.Length(7f), LengthPercentage.Length(7f), LengthPercentage.Length(7f)),
        ...
        Assert.Equal(25f, layout_node01.Location.X);
        ...
        Assert.Equal(15f, layout_node10.Location.X);
        ...
        Assert.Equal(15f, layout_node11.Location.Y);
    }
    ...
    public void ContentBox()
    {
        ...
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(260f, layout_node.Size.Width);
        Assert.Equal(130f, layout_node.Size.Height);
        Assert.Equal(0f, layout_node.Location.X);
        Assert.Equal(0f, layout_node.Location.Y);
        var layout_node0 = taffy.GetLayout(node0);
        Assert.Equal(130f, layout_node0.Size.Width);
        Assert.Equal(130f, layout_node0.Size.Height);
        Assert.Equal(0f, layout_node0.Location.X);
        Assert.Equal(0f, layout_node0.Location.Y);
        var layout_node00 = taffy.GetLayout(node00);
        Assert.Equal(10f, layout_node00.Size.Width);
        Assert.Equal(10f, layout_node00.Size.Height);
        Assert.Equal(15f, layout_node00.Location.X);
        Assert.Equal(60f, layout_node00.Location.Y);
        var layout_node01 = taffy.GetLayout(node01);
        Assert.Equal(10f, layout_node01.Size.Width);
        Assert.Equal(20f, layout_node01.Size.Height);
        Assert.Equal(25f, layout_node01.Location.X);
        Assert.Equal(55f, layout_node01.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(130f, layout_node1.Size.Width);
        Assert.Equal(130f, layout_node1.Size.Height);
        Assert.Equal(130f, layout_node1.Location.X);
        Assert.Equal(0f, layout_node1.Location.Y);
        var layout_node10 = taffy.GetLayout(node10);
        Assert.Equal(10f, layout_node10.Size.Width);
        Assert.Equal(10f, layout_node10.Size.Height);
