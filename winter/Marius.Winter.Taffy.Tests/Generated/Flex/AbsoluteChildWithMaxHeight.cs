...
public class AbsoluteChildWithMaxHeight
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            SizeValue = new Size<Dimension>(Dimension.FromLength(100f), Dimension.FromLength(30f)),
        });
        ...
        Assert.Equal(30f, layout_node00.Size.Height);
