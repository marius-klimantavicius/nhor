...
public class FlexWrapChildrenWithMinMainOverridingFlexBasis
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            MinSizeValue = new Size<Dimension>(Dimension.FromLength(55f), Dimension.Auto()),
        });
        ...
        Assert.Equal(55f, layout_node1.Size.Width);
