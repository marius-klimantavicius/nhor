...
public class WidthSmallerThenContentWithFlexGrowSmallSize
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            FlexGrowValue = 1f,
            SizeValue = new Size<Dimension>(Dimension.FromLength(0f), Dimension.Auto()),
        }, new NodeId[] { node00 });
        ...
        Assert.Equal(5f, layout_node0.Size.Width);
        ...
        Assert.Equal(5f, layout_node1.Size.Width);
