...
public class AlignContentCenterWrapped
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(120f), Dimension.FromLength(100f)),
        ...
        Assert.Equal(35f, layout_node0.Location.Y);
        ...
        Assert.Equal(35f, layout_node1.Location.Y);
        ...
        Assert.Equal(45f, layout_node2.Location.Y);
        ...
        Assert.Equal(45f, layout_node3.Location.Y);
        ...
        Assert.Equal(50f, layout_node5.Location.X);
        Assert.Equal(55f, layout_node5.Location.Y);
    }
