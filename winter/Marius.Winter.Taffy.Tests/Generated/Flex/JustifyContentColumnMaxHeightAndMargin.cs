...
public class JustifyContentColumnMaxHeightAndMargin
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            MaxSizeValue = new Size<Dimension>(Dimension.Auto(), Dimension.FromLength(80f)),
        ...
        Assert.Equal(30f, layout_node00.Location.Y);
    }
