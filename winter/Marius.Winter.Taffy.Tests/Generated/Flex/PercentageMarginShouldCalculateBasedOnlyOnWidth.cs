...
public class PercentageMarginShouldCalculateBasedOnlyOnWidth
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            FlexGrowValue = 1f,
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Percent(0.1f), LengthPercentageAuto.Percent(0.1f), LengthPercentageAuto.Percent(0.1f), LengthPercentageAuto.Percent(0.1f)),
        }, new NodeId[] { node00 });
