...
public class AlignItemsCenterWithMaxHeightPercentageWithAlignContentFlexStart
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewWithChildren(new Style
        {
            ...
            MaxSizeValue = new Size<Dimension>(Dimension.Auto(), Dimension.FromPercent(0.5f)),
