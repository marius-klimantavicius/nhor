...
public class PercentageAbsolutePosition
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            Inset = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Percent(0.3f), LengthPercentageAuto.AUTO, LengthPercentageAuto.Percent(0.1f), LengthPercentageAuto.AUTO),
        });
