...
public class BevyIssue79764Level
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node00 = taffy.NewWithChildren(new Style
        {
            ...
            PaddingValue = new Rect<LengthPercentage>(LengthPercentage.Length(5f), LengthPercentage.Length(5f), LengthPercentage.Length(5f), LengthPercentage.Length(5f)),
        }, new NodeId[] { node000 });
        var node0 = taffy.NewWithChildren(new Style
        {
            MinSizeValue = new Size<Dimension>(Dimension.FromLength(40f), Dimension.FromLength(40f)),
        ...
        Assert.Equal(190f, layout_node0.Size.Height);
        ...
        Assert.Equal(180f, layout_node00.Size.Height);
        ...
        Assert.Equal(170f, layout_node000.Size.Height);
        Assert.Equal(5f, layout_node000.Location.X);
        Assert.Equal(5f, layout_node000.Location.Y);
    }
    ...
    public void ContentBox()
    {
        ...
        Assert.Equal(190f, layout_node00.Size.Height);
        Assert.Equal(5f, layout_node00.Location.X);
        Assert.Equal(5f, layout_node00.Location.Y);
        var layout_node000 = taffy.GetLayout(node000);
        Assert.Equal(0f, layout_node000.Size.Width);
        Assert.Equal(180f, layout_node000.Size.Height);
        Assert.Equal(5f, layout_node000.Location.X);
        Assert.Equal(5f, layout_node000.Location.Y);
    }
}
