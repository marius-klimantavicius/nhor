...
public class PercentageFlexBasisCrossMaxWidth
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            MaxSizeValue = new Size<Dimension>(Dimension.FromPercent(0.6f), Dimension.Auto()),
        });
        var node1 = taffy.NewLeaf(new Style
        {
            FlexGrowValue = 4f,
            FlexBasisValue = Dimension.FromPercent(0.15f),
            MaxSizeValue = new Size<Dimension>(Dimension.FromPercent(0.2f), Dimension.Auto()),
        });
        ...
        Assert.Equal(300f, layout_node1.Size.Height);
