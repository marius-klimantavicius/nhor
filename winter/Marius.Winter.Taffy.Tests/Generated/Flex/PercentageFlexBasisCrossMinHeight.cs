...
public class PercentageFlexBasisCrossMinHeight
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            FlexGrowValue = 1f,
            MinSizeValue = new Size<Dimension>(Dimension.Auto(), Dimension.FromPercent(0.6f)),
        });
        var node1 = taffy.NewLeaf(new Style
        {
            FlexGrowValue = 2f,
            MinSizeValue = new Size<Dimension>(Dimension.Auto(), Dimension.FromPercent(0.1f)),
        });
        ...
        Assert.Equal(160f, layout_node1.Size.Height);
