...
public class GapColumnGapPercentageCyclicShrinkable
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(24f, layout_node1.Location.X);
        Assert.Equal(0f, layout_node1.Location.Y);
        var layout_node2 = taffy.GetLayout(node2);
        Assert.Equal(12f, layout_node2.Size.Width);
        Assert.Equal(40f, layout_node2.Size.Height);
        Assert.Equal(48f, layout_node2.Location.X);
