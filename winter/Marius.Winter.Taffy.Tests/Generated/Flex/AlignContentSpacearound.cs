...
public class AlignContentSpacearound
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(140f), Dimension.FromLength(120f)),
        ...
        Assert.Equal(55f, layout_node2.Location.Y);
        ...
        Assert.Equal(55f, layout_node3.Location.Y);
        ...
        Assert.Equal(95f, layout_node4.Location.Y);
    }
