...
public class DoNotClampHeightOfAbsoluteNodeToHeightOfItsOverflowHiddenParent
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(50f, layout_node.ScrollWidth());
        Assert.Equal(50f, layout_node.ScrollHeight());
