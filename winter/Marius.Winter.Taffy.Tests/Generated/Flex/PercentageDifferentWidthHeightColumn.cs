...
public class PercentageDifferentWidthHeightColumn
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            SizeValue = new Size<Dimension>(Dimension.Auto(), Dimension.FromPercent(0.3f)),
        });
        var node = taffy.NewWithChildren(new Style
        {
            FlexDirectionValue = FlexDirection.Column,
            SizeValue = new Size<Dimension>(Dimension.FromLength(200f), Dimension.FromLength(300f)),
        ...
        Assert.Equal(210f, layout_node1.Location.Y);
    }
