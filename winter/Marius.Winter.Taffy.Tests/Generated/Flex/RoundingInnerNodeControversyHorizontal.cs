...
public class RoundingInnerNodeControversyHorizontal
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(107f, layout_node2.Size.Width);
        Assert.Equal(10f, layout_node2.Size.Height);
        Assert.Equal(213f, layout_node2.Location.X);
