...
public class MeasureChildWithFlexShrinkHidden
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(91f, layout_node1.Size.Width);
        Assert.Equal(50f, layout_node1.Size.Height);
        Assert.Equal(9f, layout_node1.Location.X);
        Assert.Equal(0f, layout_node1.Location.Y);
        Assert.Equal(9f, layout_node1.ScrollWidth());
