...
public class MeasureChildWithFlexGrow
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node1 = taffy.NewLeafWithContext(new Style(), TestNodeContext.AhemText("H\u200bH\u200bH\u200bH\u200bH", WritingMode.Horizontal));
    ...
    public void ContentBox()
    {
        ...
        {
            BoxSizingValue = BoxSizing.ContentBox,
        }, TestNodeContext.AhemText("H\u200bH\u200bH\u200bH\u200bH", WritingMode.Horizontal));
        var node = taffy.NewWithChildren(new Style
        {
            BoxSizingValue = BoxSizing.ContentBox,
            SizeValue = new Size<Dimension>(Dimension.FromLength(100f), Dimension.AUTO),
