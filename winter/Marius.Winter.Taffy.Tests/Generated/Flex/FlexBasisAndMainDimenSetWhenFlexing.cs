...
public class FlexBasisAndMainDimenSetWhenFlexing
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            FlexGrowValue = 1f,
            FlexBasisValue = Dimension.FromLength(10f),
        ...
        var node1 = taffy.NewLeaf(new Style
        {
            FlexGrowValue = 1f,
            FlexBasisValue = Dimension.FromLength(10f),
            SizeValue = new Size<Dimension>(Dimension.FromLength(0f), Dimension.FromLength(50f)),
        });
