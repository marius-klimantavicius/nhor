...
public class WrapReverseRowSingleLineDifferentSize
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            SizeValue = new Size<Dimension>(Dimension.FromLength(300f), Dimension.Auto()),
        ...
        Assert.Equal(90f, layout_node3.Location.X);
