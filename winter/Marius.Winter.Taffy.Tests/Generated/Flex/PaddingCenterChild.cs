...
public class PaddingCenterChild
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node = taffy.NewWithChildren(new Style
        {
            ...
            PaddingValue = new Rect<LengthPercentage>(LengthPercentage.Length(10f), LengthPercentage.Length(20f), LengthPercentage.Length(10f), LengthPercentage.Length(20f)),
        }, new NodeId[] { node0 });
    ...
    public void ContentBox()
    {
        ...
        taffy.ComputeLayoutWithMeasure(node, MaxContentSize, MeasureFunction);
        var layout_node = taffy.GetLayout(node);
        Assert.Equal(130f, layout_node.Size.Width);
        ...
        Assert.Equal(10f, layout_node0.Size.Width);
        Assert.Equal(10f, layout_node0.Size.Height);
        Assert.Equal(55f, layout_node0.Location.X);
        Assert.Equal(55f, layout_node0.Location.Y);
    }
}
