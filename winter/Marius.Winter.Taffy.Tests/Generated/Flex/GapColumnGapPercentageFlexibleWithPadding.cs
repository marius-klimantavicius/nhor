...
public class GapColumnGapPercentageFlexibleWithPadding
{
    [Fact]
    public void BorderBox()
    {
        ...
        {
            GapValue = new Size<LengthPercentage>(LengthPercentage.Percent(0.1f), LengthPercentage.Length(20f)),
        ...
        Assert.Equal(21f, layout_node0.Size.Width);
        ...
        Assert.Equal(39f, layout_node1.Location.X);
        Assert.Equal(10f, layout_node1.Location.Y);
        var layout_node2 = taffy.GetLayout(node2);
        Assert.Equal(21f, layout_node2.Size.Width);
        Assert.Equal(80f, layout_node2.Size.Height);
        Assert.Equal(69f, layout_node2.Location.X);
    ...
    public void ContentBox()
    {
        ...
        Assert.Equal(0f, layout_node.Location.Y);
        var layout_node0 = taffy.GetLayout(node0);
        Assert.Equal(27f, layout_node0.Size.Width);
        Assert.Equal(100f, layout_node0.Size.Height);
        Assert.Equal(10f, layout_node0.Location.X);
        Assert.Equal(10f, layout_node0.Location.Y);
        var layout_node1 = taffy.GetLayout(node1);
        Assert.Equal(26f, layout_node1.Size.Width);
        Assert.Equal(100f, layout_node1.Size.Height);
        Assert.Equal(47f, layout_node1.Location.X);
        Assert.Equal(10f, layout_node1.Location.Y);
        var layout_node2 = taffy.GetLayout(node2);
        Assert.Equal(27f, layout_node2.Size.Width);
        Assert.Equal(100f, layout_node2.Size.Height);
        Assert.Equal(83f, layout_node2.Location.X);
        Assert.Equal(10f, layout_node2.Location.Y);
    }
}
