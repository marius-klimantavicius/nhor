...
public class MarginAutoMultipleChildrenColumn
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.ZERO, LengthPercentageAuto.ZERO, LengthPercentageAuto.AUTO, LengthPercentageAuto.ZERO),
        });
        ...
        Assert.Equal(75f, layout_node0.Location.X);
        ...
        Assert.Equal(75f, layout_node1.Location.X);
        ...
        Assert.Equal(75f, layout_node2.Location.X);
        Assert.Equal(150f, layout_node2.Location.Y);
    }
