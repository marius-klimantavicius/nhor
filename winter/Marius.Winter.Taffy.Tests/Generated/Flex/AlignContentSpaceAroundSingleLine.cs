...
public class AlignContentSpaceAroundSingleLine
{
    [Fact]
    public void BorderBox()
    {
        ...
        Assert.Equal(17f, layout_node0.Size.Width);
        ...
        Assert.Equal(16f, layout_node4.Size.Width);
        Assert.Equal(10f, layout_node4.Size.Height);
        Assert.Equal(67f, layout_node4.Location.X);
        Assert.Equal(0f, layout_node4.Location.Y);
        var layout_node5 = taffy.GetLayout(node5);
        Assert.Equal(17f, layout_node5.Size.Width);
        Assert.Equal(10f, layout_node5.Size.Height);
        Assert.Equal(83f, layout_node5.Location.X);
