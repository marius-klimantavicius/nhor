...
public class MarginFixLeftAutoRightChildBiggerThanParent
{
    [Fact]
    public void BorderBox()
    {
        ...
        var node0 = taffy.NewLeaf(new Style
        {
            ...
            MarginValue = new Rect<LengthPercentageAuto>(LengthPercentageAuto.Length(10f), LengthPercentageAuto.AUTO, LengthPercentageAuto.ZERO, LengthPercentageAuto.ZERO),
        });
        ...
        Assert.Equal(42f, layout_node0.Size.Width);
