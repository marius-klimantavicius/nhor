...
namespace ThorVG
{
    ...
    public class LottieObject
    {
        public enum ObjectType : byte
        {
            ...
            Image, Trimpath, Text, Repeater, RoundedCorner, OffsetPath, TextRange
        }
    ...
    public class LottieTextRange : LottieObject
    {
        ...
        public LottieFloat smoothness = new();
        public LottieFloat start = new();
        public LottieFloat end = new(float.MaxValue);
    ...
    public class LottieImage : LottieObject
    {
        ...
        public void Prepare()
        {
            ...
            var result = (bitmap.size > 0 && bitmap.b64Data != null)
                ? picture.Load(bitmap.b64Data, bitmap.size, bitmap.mimeType)
