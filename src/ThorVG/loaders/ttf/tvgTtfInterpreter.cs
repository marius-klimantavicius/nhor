// TrueType bytecode interpreter for grid-fitting (hinting).
...
namespace ThorVG
{
    ...
    internal class InvalidTrueTypeFontException : Exception
    {
    ...
    internal class TtfInterpreter
    {
        ...
        public TtfInterpreter(int maxStack, int maxStorage, int maxFunctions, int maxInstructionDefs, int maxTwilightPoints)
        {
        ...
        [Flags]
        internal enum InstructionControlFlags
        {
            None,
