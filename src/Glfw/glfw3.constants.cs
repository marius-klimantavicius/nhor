// Ported from glfw/include/GLFW/glfw3.h (GLFW 3.5)
// All #define GLFW_* constants and callback delegate types.
...
namespace Glfw
{
    public static class GLFW
    {
        ...
        public const int GLFW_KEY_BACKSLASH     = 92;  // backslash
        ...
        #region Context hints and attributes
        ...
        public const int GLFW_OPENGL_DEBUG_CONTEXT     = GLFW_CONTEXT_DEBUG; // Legacy alias
        ...
        #region Win32 specific window hints
        ...
        #region Wayland specific window hints

        public const int GLFW_WAYLAND_APP_ID = 0x00026001;

        #endregion

        #region Client API values
        ...
        #region Context robustness values
        ...
        #region Context release behavior values
        ...
        #region Context creation API values
        ...
        #region ANGLE platform type values
        ...
        #region Wayland libdecor values
        ...
        #region Monitor/joystick connection events
    ...
    {
        public byte[] buttons; // 15 elements
        public float[] axes;   // 6 elements
    }
